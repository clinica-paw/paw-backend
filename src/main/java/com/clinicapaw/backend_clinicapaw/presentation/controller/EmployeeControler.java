...
@Tag(name="Employee Controller", description = "Controller for employee crud")
@Slf4j
public class EmployeeControler {
    ...
    @Operation(
            ...
            description = "Return all employees from the data base in a format json list or return a empty list.",
            tags = {"Employee Controller"},
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Has no data",
                    required = true,
    ...
    @Operation(
            ...
            description = "Finds the employee by ID to deletes it and send confirm message in the body.",
            tags = {"Employee Controller"},
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Has no data",
                    required = true,
